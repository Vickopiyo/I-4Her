...
import footer from '../assets/morepads.jpg'
				...
				<div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
					<div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
						<div>
							...
							<ul class="flex gap-6 mt-8">
								<li>
									<a
										href="https://www.facebook.com/initiative4her"
										rel="noreferrer"
										target="_blank"
					...
					<div class="pt-12 mt-12 border-t border-gray-100 dark:border-gray-800">
						<div class="sm:flex sm:items-center sm:justify-between">
							...
							<p class="mt-8 text-xs text-gray-200 dark:text-gray-200 sm:mt-0">
								&copy; 2023. Initiative For Her. All rights reserved.
							</p>
						</div>
					</div>
				</div>
